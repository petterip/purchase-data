...
public class CmdLineOptions {
  ...
  /* textType */
  public static String extractTextType(Vector<String> args) {
		String textType = extractParameterValue("texttype", args);
		if (textType != null) {
      System.out.println("Using textType: " + textType + "\n");
			return textType;
		}

		System.out
				.println("Warning! The document will be processed with normal type.\n"
						+ "To change this, specify --texttype=<texttype> option.\n");
